package com.vaynenet.redis.lock;


import com.vaynenet.core.constant.CommonConstant;
import com.vaynenet.core.exception.LockException;
import com.vaynenet.core.lock.DistributedLock;
import com.vaynenet.core.lock.ZLock;
...
@ConditionalOnProperty(prefix = "vayne.lock", name = "lockerType", havingValue = "REDIS", matchIfMissing = true)
